...
export class firstMigration1677068505151 implements MigrationInterface {
    name = 'firstMigration1677068505151'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "User" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying(50) NOT NULL, "email" character varying(50) NOT NULL, "password" character varying(200) NOT NULL, "cpf" character varying(11) NOT NULL, "cel" character varying(12) NOT NULL, "birthdate" date NOT NULL, "accountType" character varying(15) NOT NULL, "cep" character varying(8) NOT NULL, "state" character varying(2) NOT NULL, "city" character varying(50) NOT NULL, "street" character varying(50) NOT NULL, "number" integer NOT NULL, "complement" character varying(20), "is_active" boolean NOT NULL DEFAULT true, CONSTRAINT "UQ_4a257d2c9837248d70640b3e36e" UNIQUE ("email"), CONSTRAINT "UQ_fd04577de1de205c8a1f5297318" UNIQUE ("cpf"), CONSTRAINT "UQ_d1c532fccc2cc29a01fc0a7a6a8" UNIQUE ("cel"), CONSTRAINT "PK_9862f679340fb2388436a5ab3e4" PRIMARY KEY ("id"))`);
