...
class AnnouncementService {
    ...
    static async createAnnouncementsService(data: ICreateAnnouncementData, id:string) {
        const manager = AppDataSource.getRepository(Announcement)
    ...
    static async updateAnnouncementService(id: string, data: IUpdateAnnouncement) {
